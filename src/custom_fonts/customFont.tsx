...
export const Toathmor = fontMaker({
  weight: 'Regular',
  family: 'Toathmor',
  familyIOS: 'Kh Ang Moul Toathmor',
});
export const PlayfairDisplay = fontMaker({
  weight: 'Regular',
  family: 'PlayfairDisplay',
  familyIOS: 'PlayfairDisplay-Regular',
});
export const PlayfairDisplayBold = fontMaker({
  weight: 'Bold',
  family: 'PlayfairDisplay',
  familyIOS: 'PlayfairDisplay-Bold',
});
export const LoraBold = fontMaker({
  weight: 'Bold',
  family: 'Lora',
  familyIOS: 'Lora-Bold',
});
export const Lora = fontMaker({
  weight: 'Regular',
  family: 'Lora',
  familyIOS: 'Lora-Regular',
});
export const Misto = fontMaker({
  weight: 'Bold',
  family: 'Misto',
  familyIOS: 'Misto',
});
